...
// Body parsers MUST come early, before any middleware that reads the body
...
// Apply API rate limiter to all routes except health checks
app.use((req, res, next) => {
...
const startServer = async () => {
  try {
    ...
    server = app.listen(PORT, () => {
      logger.info(`Identity Provider service started`, {
        port: PORT,
